...
namespace CompressionStockingApplication
{
    ...
    class CompressionStockingApplication
    {
        ...
        {
            IPump Pump_ = new Pump(); // Using the Interface as the variabletype, not the actual implementation. 
            Timer Timer_ = new Timer();

            var compressionStockingstocking = new StockingCtrl(new CompressionCtrl(Pump_,Timer_));
